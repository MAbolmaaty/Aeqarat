 ...
 */
public class RealEstateRequestsUserFragment extends Fragment {

    @BindView(R.id.toolbarAction1)
    ImageView mBack;
    @BindView(R.id.toolbarTitle1)
    TextView mTitle;
    @BindView(R.id.requestsHistory)
    ImageView mRequestsHistory;
    @BindView(R.id.noRequests)
    TextView mNoRequests;
    @BindView(R.id.view_termination)
    View mTermination;
    @BindView(R.id.view_maintenance)
    View mMaintenance;
    ...
    public RealEstateRequestsUserFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_real_estate_requests_user, container, false);
    ...
    @OnClick(R.id.requestsHistory)
    public void requestsHistory() {
        loadFragment(RealEstateRequestsUserFragment.this.getActivity().getSupportFragmentManager(),
                new RealEstateRequestsUserHistoryFragment(),
                true);
    }

    @OnClick(R.id.view_termination)
    ...
    private void loadRequests(String realEstateId) {
        ...
        viewModelRealEstateRequests.failure().observe(this, failed -> {
            if (failed) {
                mToast = Toast.makeText(RealEstateRequestsUserFragment.this.getActivity(),
